...
function Register() {
  ...
  const validateForm = () => {
    const {fullName, phone, address,role,email, password, passwordConfirm } = user;
    let newErrors = {};
    if (!fullName) {
  ...
  const handleSubmit = async(e) => {
    ...
    if ( !validationErrors.email && !validationErrors.password && !validationErrors.fullName && !validationErrors.phone && !validationErrors.address && !validationErrors.passwordConfirm && !validationErrors.role) {
      // setIsSubmitted(true);
        ...
        <div className="mb-4">
          ...
          <div className="mb-6">
            ...
            {errors.passwordConfirm && (
              <p className="text-red-500 text-sm mt-2">{errors.passwordConfirm}</p>
            )}
          </div>
