    ...
    <div className="relative text-center">
        ...
        <div className="absolute inset-0 flex flex-col justify-center items-center px-4 sm:px-8 md:px-16 lg:px-24">
          <div className="m-auto w-full max-w-4xl text-center text-white">
            <h3 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl">About Us</h3>
      ...
      <section className="relative py-8">
        <div className="relative">
          ...
          />
          <div className="absolute inset-0 bg-black opacity-60"></div> {/* تراكب غامق */}
          <div className="absolute inset-0 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 border-white border-opacity-50 overflow-hidden">
            ...
            <div className="flex flex-col items-center justify-center space-y-2 border-b md:border-b-0 md:border-r border-white border-opacity-50 h-full p-2 md:p-4">
              <h2 className="text-lg md:text-2xl lg:text-3xl xl:text-4xl font-bold text-white">10k+</h2>
              <p className="text-xs md:text-sm lg:text-base xl:text-lg text-white">Products Sold</p>
            </div>
            
            <div className="flex flex-col items-center justify-center space-y-2 border-b md:border-b-0 md:border-r border-white border-opacity-50 h-full p-2 md:p-4">
              <h2 className="text-lg md:text-2xl lg:text-3xl xl:text-4xl font-bold text-white">35</h2>
              <p className="text-xs md:text-sm lg:text-base xl:text-lg text-white">Years Service</p>
            </div>
            
            <div className="flex flex-col items-center justify-center space-y-2 border-b md:border-b-0 md:border-r border-white border-opacity-50 h-full p-2 md:p-4">
              <h2 className="text-lg md:text-2xl lg:text-3xl xl:text-4xl font-bold text-white">450</h2>
              <p className="text-xs md:text-sm lg:text-base xl:text-lg text-white">Outlets Worldwide</p>
            </div>
      ...
      <section className="py-16 bg-black text-white">
          <div className="container mx-auto px-4">
            ...
            <div className="text-center mb-12">
              <p className="text-[--mainColor] mb-4 text-sm md:text-base lg:text-lg">DIVERSE RANGE</p>
              <h2 className="text-xl md:text-2xl lg:text-4xl text-white">Customized Furniture</h2>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-2 gap-4">
                ...
                <div className="flex flex-col items-center justify-center border border-white border-opacity-50 p-6 rounded-md hover:bg-[--mainColor] transition duration-300">
                  <FontAwesomeIcon icon={faUtensils} className="text-4xl sm:text-5xl text-white mb-3" />
                  <p className="text-base sm:text-lg md:text-xl text-white">Dining Room</p>
                </div>
                
                <div className="flex flex-col items-center justify-center border border-white border-opacity-50 p-6 rounded-md hover:bg-[--mainColor] transition duration-300">
                  <FontAwesomeIcon icon={faCouch} className="text-4xl sm:text-5xl text-white mb-3" />
                  <p className="text-base sm:text-lg md:text-xl text-white">Living Room</p>
                </div>
                
                <div className="flex flex-col items-center justify-center border border-white border-opacity-50 p-6 rounded-md hover:bg-[--mainColor] transition duration-300">
                  <FontAwesomeIcon icon={faBlender} className="text-4xl sm:text-5xl text-white mb-3" />
                  <p className="text-base sm:text-lg md:text-xl text-white">Kitchen</p>
                </div>
                
                <div className="flex flex-col items-center justify-center border border-white border-opacity-50 p-6 rounded-md hover:bg-[--mainColor] transition duration-300">
                  <FontAwesomeIcon icon={faBriefcase} className="text-4xl sm:text-5xl text-white mb-3" />
                  <p className="text-base sm:text-lg md:text-xl text-white">Office</p>
                </div>
                
                <div className="flex flex-col items-center justify-center border border-white border-opacity-50 p-6 rounded-md hover:bg-[--mainColor] transition duration-300">
                  <FontAwesomeIcon icon={faBed} className="text-4xl sm:text-5xl text-white mb-3" />
                  <p className="text-base sm:text-lg md:text-xl text-white">Bedroom</p>
                </div>
                
                <div className="flex flex-col items-center justify-center border border-white border-opacity-50 p-6 rounded-md hover:bg-[--mainColor] transition duration-300">
                  <FontAwesomeIcon icon={faChair} className="text-4xl sm:text-5xl text-white mb-3" />
                  <p className="text-base sm:text-lg md:text-xl text-white">Waiting Hall</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="py-16 bg-black text-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <h2 className="text-xl md:text-2xl lg:text-4xl text-white">Special Team</h2>
          </div>
      ...
      <section className="relative py-20">
        <div className="relative">
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center text-center text-white px-4 md:px-8">
            ...
            <p className="text-[--mainColor] mb-4 text-sm md:text-base lg:text-lg">ART OF COMFORT</p>
            <h2 className="text-xl md:text-2xl lg:text-3xl font-bold mb-4">Transforming Spaces</h2>
            <h2 className="text-xl md:text-2xl lg:text-3xl font-bold mb-6">Transforming Style</h2>
            ...
            <div className="flex items-center justify-center space-x-2 text-sm md:text-base">
              <input type="checkbox" className="form-checkbox h-4 w-4 text-[--mainColor] rounded focus:ring-2 focus:ring-[--mainColor]" />
              <span>Your email is safe with us, we don't spam.</span>
              <a href="#" className="text-blue-400 hover:text-blue-600 underline ml-2">Privacy Policy</a>
            </div>
