          ...
          <div>
            ...
            <div className="mb-8">
              <ul className="md:relative px-7 grid grid-cols-10 items-center">
                {
                  orderData && orderData.products.map((order) => (
                    <li key={order} className="col-span-full md:col-span-4 flex flex-col md:flex-row items-center gap-0 md:gap-6">
            ...
            <div className="mb-8 bg-[#2B2B2B] text-center md:text-start rounded-br-xl rounded-bl-xl relative">
              ...
              <div className="p-8 text-white ">
                ...
                methods.please contact us if you require assistance or wish to
